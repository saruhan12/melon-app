...
const Register = () => {
    ...
    const handleRegister = async () => {
        console.log('Registering with:', { username, email, password, passwordConfirm });
    ...
    return (
        <VStack minH="500px" w="70%" maxW="400px" justifyContent="start" alignItems="start">
            ...
            <Button mb="10px" colorScheme="green" mt="20px" w="100%" onClick={handleRegister}>
                Register
            </Button>
            <Text onClick={handleNavigate} cursor="pointer" color="gray.600" fontSize="14px">
